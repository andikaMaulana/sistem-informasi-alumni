  ...
  <section class="content">
    ...
    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
      <div class="form-group">
       <div class="form-line">
        <input type="date" id="tanggal_lahir" class="form-control" name="tanggal_lahir" placeholder="Please choose a date..." required="" value="<?=$data['tanggal_lahir']?>">
      </div>
    </div>
  </div>
</div>
  ...
  <div class="form-group">
   <div class="form-line">
    <div class="demo-radio-button">
     <input name="jenis_kelamin" type="radio" id="jenis_kelamin_1" value="L" />
     <label for="jenis_kelamin_1">Laki-Laki</label>
     <input name="jenis_kelamin" type="radio" id="jenis_kelamin_2" value="P" />
     <label for="jenis_kelamin_2">Perempuan</label>
   </div>
 </div>
</div>
</div>
...
<div class="row clearfix">
 ...
 <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
  ...
  <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
    <div class="form-group">
     <div class="form-line">
      <input type="number" id="telepon" name="telepon" class="form-control" placeholder="Enter your phone number" value="<?=$data['telepon']?>" required>
    </div>
  </div>
</div>
</div>
...
<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
  <div class="form-group">
   <div class="form-line">
    <input type="text" id="tempat_kerja" name="tempat_kerja" class="form-control" placeholder="Enter your work place" value="<?=$data['tempat_kerja']?>">
  </div>
</div>
</div>
</div>
...
<div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
  <div class="form-group">
   <div class="form-line">
    <textarea rows="4" id="tentang" class="form-control no-resize" name="tentang" placeholder="Please type what you want..." required=""><?=$data['tentang']?></textarea>
  </div>
</div>
</div>
</div>
